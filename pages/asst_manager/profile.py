...
def render_profile():
    """Render profile page for assistant manager."""
    if not check_asst_manager():
        st.error("You don't have permission to access this page.")
        return
    
    render_page_title("Assistant Manager Profile", "Update your profile information", "👤")
    ...
    with st.container(border=True):
        ...
        st.write("**Access Level:** Assistant Manager")
        st.write("**Permissions:**")
        st.write("- Create general employees")
        st.write("- Assign tasks to general employees")
        st.write("- View employee reports")
        st.write("- Deactivate or reactivate general employees")
        st.write("- Communicate with company and general employees")
