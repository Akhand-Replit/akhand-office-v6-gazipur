...
def render_employee_management():
    """Render employee management page for manager."""
    if not check_manager():
        st.error("You don't have permission to access this page.")
        return
    
    render_page_title("Employee Management", "Create and manage employees in your branch", "👥")
    ...
    with st.container(border=True):
        with st.form("create_employee_form"):
            ...
            with col2:
                ...
                # Managers can only create general employees
            ...
            if submit_button:
                if not employee_name or not username or not password:
                    ...
                    employee_id = create_employee(
                        ...
                        st.session_state.company_id, st.session_state.branch_id, "manager", st.session_state.user_id
                    )
    ...
    tab1, tab2 = st.tabs(["Assistant Managers", "General Employees"])
    ...
    with tab1:
        if asst_managers:
            for employee in asst_managers:
                ...
                with st.container(border=True):
                    ...
                    with col2:
                        ...
                        st.write("Role: Assistant Manager")
            ...
            st.info("No assistant managers found in your branch")
